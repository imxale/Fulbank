...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 07 avr. 2022 à 15:45
...
(33, 1, 'Arnaud', 'Paul', '2002-05-15', 'arnaudpaul15@gmail.com', '42 rue parisis', 'Dreux', 28100, 'paul', '+FazYBYU7uvEmsR0yJWetbZMREkhTHY4RcMY28cj+D386zExbVO9o9Hf/4eDoHuEiHrc9OTocjenqdnb7CP2zA==', '2021-10-07', 1),
...
(40, 1, 'KASMI', 'Sabra', '1995-06-16', 'sabra@email.com', '45 rue du puit', 'Lucé', 28001, 'sabra', '5Nm8MioQk152OBH3xciJHQBuNXFfKUCWxcvT8bs7zzniRtCoZqCPG6UfTyoegZKfQGzoCn5dB/A/5cEhSnIdsQ==', '2022-03-28', 1);
...
INSERT INTO `rendezvous` (`IDRENDEZVOUS`, `IDPERSON`, `IDREASON`, `COMMENT`) VALUES
(1, 33, 1, 'TEst'),
(11, 33, 1, 'Test'),
(10, 33, 1, 'Bonjour');
...
(149, 33, 0, 0, 10000, '2022-03-24', 'Achat Crypto', 0, 0),
(150, 33, 0, 0, 1000, '2022-03-24', 'Achat Crypto', 0, 0),
(151, 33, 0, 0, 10000, '2022-03-24', 'Achat Crypto', 0, 0),
(152, 33, 0, 0, 10000, '2022-03-24', 'Achat Crypto', 0, 0),
(153, 33, 0, 0, 10000, '2022-03-24', 'Achat Crypto', 0, 0),
(154, 33, 0, 0, 10000, '2022-03-24', 'Achat Crypto', 0, 0),
(155, 33, 0, 0, 1, '2022-03-24', 'Achat Crypto', 0, 1),
(156, 33, 0, 0, 1, '2022-03-24', 'Achat Crypto', 0, 1),
(157, 33, 0, 4, 1, '2022-03-24', 'Achat Crypto', 0, 1),
(158, 33, 0, 4, 1, '2022-03-24', 'Achat Crypto', 0, 1),
(159, 33, 0, 1, 1, '2022-03-24', 'Achat Crypto', 0, 1),
(160, 33, 0, 1, 1, '2022-03-24', 'Achat Crypto', 0, 1),
(161, 33, 0, 1, 1, '2022-03-24', 'Achat Crypto', 0, 1),
(162, 33, 0, 3, 100, '2022-03-24', 'Achat Crypto', 0, 1),
(163, 33, 0, 3, 100, '2022-03-24', 'Achat Crypto', 0, 1),
(164, 33, 0, 0, 4, '2022-03-28', 'Achat Crypto', 0, 1),
(165, 33, 0, 25, 4, '2022-03-28', 'Vente Crypto', 0, 1),
(166, 33, 0, 25, 4, '2022-03-28', 'Vente Crypto', 0, 1),
(167, 33, 0, 25, 4, '2022-03-28', 'Vente Crypto', 0, 1),
(168, 33, 0, 0, 1, '2022-03-28', 'Achat Crypto', 0, 1),
(169, 33, 0, 22, 1210, '2022-03-31', 'Achat Crypto', 0, 1),
(170, 33, 0, 22, 1210, '2022-03-31', 'Achat Crypto', 0, 1),
(171, 33, 0, 0, 4721128, '2022-03-31', 'Achat Crypto', 0, 1),
(172, 33, 1, 0, 1000000, '2022-03-31', 'Dépot', 0, 1),
(173, 33, 0, 0, 0, '2022-03-31', 'Vente Crypto', 1, 0),
(174, 33, 0, 4, 3404, '2022-03-31', 'Vente Crypto', 1, 0),
(175, 33, 0, 3, 10, '2022-03-31', 'Vente Crypto', 1, 0),
(176, 33, 0, 1, 47211, '2022-03-31', 'Vente Crypto', 1, 0),
(177, 33, 1, 0, 10000000, '2022-04-07', 'Dépot', 0, 2),
(178, 33, 1, 0, 100000, '2022-04-07', 'Retrait', 0, 2);
...
CREATE TABLE IF NOT EXISTS `wallet` (
  ...
  `NOMCRYPTO` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `IDPERSON` int(2) NOT NULL,
  `NAME` char(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `QUANTITY` decimal(10,7) DEFAULT '0.0000000',
...
INSERT INTO `wallet` (`IDWALLET`, `NOMCRYPTO`, `IDPERSON`, `NAME`, `QUANTITY`) VALUES
(4, 'Ethereum', 33, 'Kader', '12.0000000'),
(3, 'USD Coin', 33, 'KaderCryptoChef', '30.0000000'),
(26, 'Cardano', 33, 'Cardano', '22.0000000');
COMMIT;
